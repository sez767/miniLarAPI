...
class PeopleController extends Controller
{
    ...
    public function index(IndexPerson $request)
    {
        ...
        $data = AdminListing::create(Person::class)->processRequestAndGet(
            ...
            ['id', 'name', 'surname', 'phone_number', 'gmail','new', 'tour_name', 'arrival_name'],

            // set columns to searchIn
            ['id', 'name', 'surname', 'phone_number', 'gmail', 'tour_name', 'arriavl_name']
        );
     ...
     */
    public function store(StorePerson $request,$id){
    
        $validatedData = $request->validate([
            'name' => ['nullable', 'string'],
            'surname' => ['nullable', 'string'],
            'gmail' => ['nullable', 'email', 'string'],
    ...
    {   
        ...
        $person->gmail=$request->input('gmail');
        $person->phone_number=$request->input('phone_number');
        
        $person->arrival_id=$arrival->id;
        $person->arrival_name=$arrival->name;
        $person->tour_name=$arrival->tour->title;
