            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Тури
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/tours/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; Додати тур</a>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'title'">Назва туру</th>
                                        <th :column="'description'">Опис туру</th>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <p>Спробуйте змінити фільтр чи створити новий</p>
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/tours/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; Додати тур</a>
                            </div>
                        </div>
                    </div>
                </div>
